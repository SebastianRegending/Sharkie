class StatusbarHealth extends DrawableObject {
    ...
    /**
     * Loads the position and images of the health statusbar
     */
    constructor() {
        super();
    ...
    /**
     * Sets the precentage of the health statusbar
    ...
    /**
     * Sets the number to update the level of the health statusbar
     * @returns number
     */
